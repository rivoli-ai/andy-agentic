...
namespace Andy.Agentic.Infrastructure.Migrations
{
    ...
    [Migration("20260622180710_AddSkillsUsedToChatMessage")]
    partial class AddSkillsUsedToChatMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Andy.Agentic.Domain.Entities.AgentSkillEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("SkillRegistryId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SkillRegistryId");

                    b.HasIndex("AgentId", "SkillRegistryId", "Namespace", "SkillSlug", "Version")
                        .IsUnique();
            ...
            modelBuilder.Entity("Andy.Agentic.Domain.Entities.DocumentExportEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Andy.Agentic.Domain.Entities.SkillRegistryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Andy.Agentic.Domain.Entities.AgentSkillEntity", b =>
                {
                    ...
                    b.HasOne("Andy.Agentic.Domain.Entities.SkillRegistryEntity", "Registry")
                        .WithMany()
                        .HasForeignKey("SkillRegistryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
