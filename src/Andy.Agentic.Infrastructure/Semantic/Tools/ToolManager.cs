...
public class ToolManager : IToolManager
{
    ...
    /// <param name="internalToolFactory">Factory for creating internal tools.</param>
            ...
            ILogger<ToolManager>? logger = null)
    {
        _toolFactories = new Dictionary<ToolType, IToolFactory>
        {
            ...
            { ToolType.InternalTool, nativeToolFactory },
        };
        _logger = logger;
    }
    ...
    /// </returns>
    public void AddToolsAsync(Kernel kernel, Agent agent, List<Tool> tools)
    {
        ...
        foreach (var tool in tools)
        {
            try
            {
                ...
                {
                    var function = factory.CreateToolAsync(agent,tool);
