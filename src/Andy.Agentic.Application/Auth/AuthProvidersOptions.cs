...
/// <summary>
/// Configuration root for SPA-login auth providers exposed at <c>/api/auth/{provider}/*</c>.
...
/// <summary>
/// One named auth provider — typically Microsoft Entra ID or Duende IdentityServer.
/// </summary>
